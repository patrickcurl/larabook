...
<h3>:: Edit Profile ::</h3>
{{ Form::open(array('action' => 'BookController@updateprofile', 'method' => 'POST')) }}
...
<table class="table table-striped">
	...
	<tr>
		<td>Password</td>
		<td><input type="password" name="password" id="password" value="{{Crypt::decrypt(Auth::user()->password)}}" /></td>
	</tr>
	<tr>
		<td>Phone</td>
